      ...
      <div className="text-center w-full max-w-[800px] mx-auto rounded-xl bg-[#f5f5f2] p-4">
        <form className="flex gap-[0_8px] w-full" onSubmit={handleSubmit}>
          <input
            type="text"
            value={username}
            className="p-3 w-full border border-solid border-gray-300 rounded-lg focus:outline-none focus:border-gray-500 focus:ring-2 focus:ring-gray-200 hover:border-gray-400 transition-colors placeholder:text-gray-400"
